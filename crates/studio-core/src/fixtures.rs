...
const CARD_CONSTRAINTS: &str =
    "中性灰底，均匀柔光，无阴影投射，主体完整入画不裁切，画面中不出现乱码文字、假字幕或水印";
        ...
        StageId::Idea => wrap(
            ...
            json!({
                ...
                "success_metrics": [
                    ...
                    "30度侧脸至少出现在4/5镜头",
                    "9:16竖屏，画面里不出现乱码文字或水印"
                ],
                "rights_and_safety_risks": [
                    { "risk": "游客肖像进入画面", "level": "可规避", "mitigation": "背景人物虚化" },
        ...
        StageId::VisualAssets => wrap(
            ...
            json!({
                ...
                "assets": [
                    ...
                    card(
                        "P01", "prop_card", "透明冷饮杯，杯壁带冷凝水", "1:1",
                        &["sh03", "sh04"],
                        &[
                            ("front", "正面单物体，杯身完整入画"),
                            ("side", "侧面，可见杯壁厚度与杯底"),
            ...
            json!({
                ...
                "shots": [
                    { "shot_id": "sh01", "head": "reference", "width": 768, "height": 1344,
                      ...
                      "positive": "船头切开清透湖面，一位20岁东亚女性，长黑发及胸，白色无袖连衣裙，低帮白色板鞋，奶油色小斜挎包，以约30度侧脸快速入画并转头露出笑容。船行的风把碎发吹到她嘴角，她抬手把碎发别到耳后。层叠群岛与远山在后景。上午冷白自然光，柔光顺照，低对比。[Push in] 镜头缓慢前推。一镜到底，不切场景，人物保持在画面中央，画面中不出现乱码文字、假字幕或水印。",
                    ...
                    { "shot_id": "sh02", "head": "reference", "width": 768, "height": 1344,
                      ...
                      "positive": "一位20岁东亚女性，长黑发及胸，白色无袖连衣裙，低帮白色板鞋，奶油色小斜挎包，沿湖边木质步道轻快小跑两步。湖风从左侧推来，裙摆和发梢一起向右扬；落地时脚踝先内扣再蹬直，重心前倾半步。顺光明亮，低对比，背景是湖面与远岛。[Tracking shot] 镜头横向跟移，与她同速。一镜到底，不切场景，人物保持在画面中央，画面中不出现乱码文字、假字幕或水印。",
                    ...
                    { "shot_id": "sh03", "head": "reference", "width": 768, "height": 1344,
                      ...
                      "positive": "一位20岁东亚女性，长黑发及胸，白色无袖连衣裙，低帮白色板鞋，奶油色小斜挎包，在观景台举起一部手机取景，眯了一下眼，拇指在快门键上停半秒后按下。正午硬光，手机屏幕反着湖面的白，高对比。[Pan right] 镜头向右缓慢横摇，从她的侧脸摇到湖中群岛。一镜到底，不切场景，画面中不出现乱码文字、假字幕或水印。",
                    ...
                    { "shot_id": "sh04", "head": "reference", "width": 768, "height": 1344,
                      ...
                      "references": [{ "kind": "image", "asset_id": "C01" },
                                     { "kind": "image", "asset_id": "P01" }],
                      "positive": "近景：一位20岁东亚女性，长黑发及胸，白色无袖连衣裙，低帮白色板鞋，奶油色小斜挎包，举起一只透明冷饮杯，与画外伸入的另一只杯子轻碰。杯壁的冷凝水滑到虎口，指节收紧握住杯身，笑的时候肩膀轻轻一耸。下午暖金侧光，背景的湖岛虚化。[Static shot] 固定机位，镜头不移动。一镜到底，不切场景，画面中不出现乱码文字、假字幕或水印。",
                    ...
                    { "shot_id": "sh05", "head": "reference", "width": 768, "height": 1344,
                      ...
                      "references": [{ "kind": "image", "asset_id": "C01" },
                                     { "kind": "image", "asset_id": "SC03" }],
                      "positive": "夕阳逆光下，一位20岁东亚女性，长黑发及胸，白色无袖连衣裙，低帮白色板鞋，奶油色小斜挎包，转身回头向镜头挥手，先动眼神再动脖子，抬手挥到肩高。逆光把发丝勾出暖金边，风把裙摆吹成一道弧，湖面与远山在身后。[Pedestal up] 镜头缓慢升高。一镜到底，不切场景，画面中不出现乱码文字、假字幕或水印。",
...
mod tests {
    ...
    fn prompts_for_minimax_carry_constraints_positively() {
        ...
        for shot in pack["prompt_pack"]["shots"].as_array().unwrap() {
            ...
            let positive = shot["positive"].as_str().unwrap();
            assert!(
                positive.contains("一镜到底") && positive.contains("不出现乱码文字"),
                "{} 缺少正向写法的连续性与排版约束",
                shot["shot_id"]
            );
            assert!(
